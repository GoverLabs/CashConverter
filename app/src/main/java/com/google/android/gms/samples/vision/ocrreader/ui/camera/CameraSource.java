...
public class CameraSource {
    ...
    public static class Builder {
        private final IFrameProcessor processor;
         ...
         */
        public Builder(Context context, IFrameProcessor processor) {
            if (context == null) {
        ...
        public CameraSource build() {
            cameraSource.frameProcessor = cameraSource.new FrameProcessingRunnable(processor);
            return cameraSource;
        }
    }
    ...
    private class FrameProcessingRunnable implements Runnable {
        ...
        FrameProcessingRunnable(IFrameProcessor processor) {
            this.processor = processor;
        }
        ...
        public void run() {
            ...
            while (true) {
                ...
                try {
                    if (outputFrame != null && this.processor.isAvailable()) {
                        this.processor.processFrame(outputFrame);
                    }
                } catch (Throwable t) {
